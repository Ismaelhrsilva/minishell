...
/*   Updated: 2024/07/18 18:11:26 by paranha          ###   ########.org.br   */
/*                                                                            */
/* ************************************************************************** */
...
int								ft_aux_parse_char(char *ch, t_parse *parse,
									char *prompt);
...
char							*ft_parse_expand_heredoc(char *s,
									t_shell *shell);
...
char							ft_signal(t_vector *vector, size_t *i,
									char signal);
...
int								ft_before_brackets(t_vector *phrase, char *str,
									size_t pos);
...
int								ft_pos_token(t_vector *phrase, int start,
									int end, int token);
...
t_vector						*ft_vector_slice_right(t_vector *vector,
									unsigned long pos);
unsigned long					ft_vector_insert(t_vector *vector,
									unsigned long position, void *value);
...
void							*ft_value(const t_vector *vector,
									unsigned long i, unsigned long j);
void							*ft_vector_at(const t_vector *vector,
									unsigned long index);
void							ft_vector_erase(t_vector *vector,
...
void							ft_expand_before_exec(t_node *root,
									t_shell *shell);
...
void							ft_error(char *cmd, char *flag, char *msg,
									int status);
